...
public class TargetIndex {
  ...
  public TargetIndex(Alignment alignment) {
    ...
    for (Cell cell : alignment.getCells()) {
      ...
      if (target != null) {
        EntityDefinition targetDef = AlignmentUtil.getAllDefaultEntity(target.getDefinition(), true);
  ...
  public List<Cell> getCellsForTarget(EntityDefinition def) {
    return Collections.unmodifiableList(cells.get(AlignmentUtil.getAllDefaultEntity(def, true)));
  }
